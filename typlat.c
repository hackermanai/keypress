...
//
// Compile:
//  xcrun clang -O2 typlat.c -framework ApplicationServices -o typlat
//
// Run from Terminal:
//  ./typlat --pick --region-w 120 --region-h 80 --count 100 --out result.csv
//
...
int main(int argc, char **argv) {
    ...
    printf("Fixed-cell latency test\n");
